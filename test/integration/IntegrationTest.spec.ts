                ...
                for (let i = 0; i < 9; i++) {
                    ...
                    if (i != 3 && i != 4) {
                        ...
                        if (i == 1 || i == 2) {
                            ...
                            expect(expectedCTokensAtSavingAccount).to.be.bignumber.equal(
                                balCTokens.div(new BN(10).pow(new BN(6)))
                            );
                        } else if (i == 8) {
            ...
            context("should succeed", async () => {
                ...
                it("should deposit DAI and 3 different users should borrow USDC in gaps of 1 month", async () => {
                    ...
                    for (let u = 2; u <= 4; u++) {
                        ...
                        let userTotalBalanceBeforeDAI = await savingAccount.tokenBalance(
                            addressDAI,
                            {
                                from: userNumber
                            }
                        ...
                        const expectedTokensAtSavingAccountContract = depositAmountCollateral
                            ...
                            .div(new BN(100));
                        expect(
                            expectedTokensAtSavingAccountContract.mul(
                                userBorrowIndex.sub(new BN(1))
                            )
                        ...
                        let userTotalBalanceAfterDAI = await savingAccount.tokenBalance(
                            addressDAI,
                            {
                                from: userNumber
                            }
