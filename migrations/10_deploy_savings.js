...
//Helper contracts
const savingsDataHelper = artifacts.require("SavingsDataHelper");
...
module.exports = async function (deployer, network) {
    ...
    const claim = await deployer.deploy(Claim);
    console.log("=========================Deploy TokenRegistry============================");
    
    const savingsDataHelper = await deployer.deploy(SavingsDataHelper, globalConfig.address, claim.address);
    console.log("=========================Deploy SavingsDataHelper============================");
    ...
    console.log("SavingsDataHelper:", savingsDataHelper.address);
};
