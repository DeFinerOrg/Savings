...
interface mockERC20InterfaceFINV1_1{
...
contract ETHPerFIN {
    ...
    function latestAnswer() public view returns (int256){
        uint balance0 = mockERC20InterfaceFINV1_1(FIN).balanceOf(uniswap); // 383328811522809054672340
        uint balance1 = mockERC20InterfaceFINV1_1(WETH).balanceOf(uniswap); // 646683755097326209560
