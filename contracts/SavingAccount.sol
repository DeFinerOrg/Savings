...
contract SavingAccount is usingProvable {
	...
	constructor() public payable{
		...
		string memory ratesURL = "json(https://api.rinkeby.definer.org/OKh4I2yYpKU8S2af/definer/api/v1.0/saving_pool/rates/current).[ETH,DAI,USDC,USDT,TUSD,PAX,GUSD,BNB,MKR,BAT,OMG,GNT,ZRX,REP,CRO,WBTC,FIN].USD";
		string memory tokenNames = "ETH,DAI,USDC,USDT,TUSD,PAX,GUSD,BNB,MKR,BAT,OMG,GNT,ZRX,REP,CRO,WBTC,FIN";
		...
		tokenAddresses[16] = 0xaB8Ad2d7f39A54960Be8b71e01276a9E897833eE;
