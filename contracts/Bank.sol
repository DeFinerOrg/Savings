...
contract Bank is Constant, Initializable{
 ...
 // sichaoy: should not be public, why cannot we find _tokenIndex from token address?
    function deposit(address _to, address _token, uint256 _amount) public onlyAuthorized {
    ...
    function borrow(address _from, address _token, uint256 _amount) public onlyAuthorized {
    ...
    function repay(address _to, address _token, uint256 _amount) public onlyAuthorized returns(uint) {
     ...
     */
    function withdraw(address _from, address _token, uint256 _amount) public onlyAuthorized returns(uint) {
