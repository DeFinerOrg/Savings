    ...
    function getBorrowRatePerBlock(address _token) public view returns(uint) {
        ...
        if(isSupportedOnCompound) {
            ...
            if(capitalUtilizationRatio > (1e18 - 2e16)) { // > 0.98
                ...
                rateConstant = rateCurveConstant.mul1e18.div(nonUtilizedCapRatio).div(BLOCKS_PER_YEAR);
                return compoundSupplyPlusBorrow.add(rateConstant);
            }
        } else {
            ...
            if(capitalUtilizationRatio > (1e18 - 2e16)) { // > 0.98
                ...
                return rateCurveConstant.mul1e18.div(nonUtilizedCapRatio).div(BLOCKS_PER_YEAR);
            }
        }
    }
