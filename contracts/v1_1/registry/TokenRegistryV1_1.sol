 ...
 */
contract TokenRegistryV1_1 is Ownable, ConstantV1_1 {
     ...
     */
    function initialize(GlobalConfigV1_1 _globalConfig) public onlyOwner{
    ...
    function priceFromIndex(uint index) public view returns(uint256) {
        ...
        // Temp fix
        if(UtilsV1_1._isETH(address(globalConfig), tokenAddress)) {
            return 1e18;
        }
